<template>
  <div class="classManage">
    <div class="class_tool_bar">
      <div class="class_tool_search">
      ...
      <el-button
        type="primary"
        icon="el-icon-menu"
        style="float: right; background: #3289ff"
        @click="add_class"
        >添加分类</el-button
      >
    </div>
    ...
    <div class="class_table">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="address" label="讲座数量" align="center">
        </el-table-column>
        <el-table-column prop="address" label="显示顺序" align="center">
        </el-table-column>
        <el-table-column prop="address" label="加入时间" align="center">
        </el-table-column>
        <el-table-column prop="address" label="创建人员" align="center">
        </el-table-column>
        <el-table-column prop="address" label="操作" align="center">
          <!-- <template slot-scope="scope"> -->
          <el-button size="text" @click="dialogVisible = true">修改</el-button>
          <span>|</span>
          <el-button size="text" type="danger" @click="class_manage_delete"
            >删除</el-button
          >
          <!-- </template> -->
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    // 添加分类
    add_class() {
      this.$router.push("/AddClassMange");
    },
  },
};
</script>
...
//   background: rgba(102, 114, 251, 0.1) !important;
// }
</style>                                                                                                                       