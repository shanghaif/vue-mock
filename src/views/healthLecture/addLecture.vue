  ...
  <div class="addLecture">
    ...
    <div class="addLecture_table">
      <el-table :data="tableData" border style="width: 100%">
        <el-table-column prop="date" label="讲座标题" width="180" align="center">
        </el-table-column>
        <el-table-column prop="name" label="讲座分类" width="180" align="center">
        </el-table-column>
        ...
        <el-table-column prop="address" label="操作" align="center">
          ...
          <el-button size="text" type="danger" @click="addLecture_play">播放</el-button>
          <span>|</span>
          <el-button size="text" type="danger" @click="health_delete">删除</el-button>
          <!-- </template> -->
        </el-table-column>
        <el-table-column
      type="selection"
